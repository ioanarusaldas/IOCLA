...
{ 
    ...
    if (error_buffer == NULL)
    {
        ...
        strcpy(error_buffer,"Your code for malloc error");
        goto final;
    ...
    { 
        strcpy(error_buffer,"Your code for socket creation error");
        goto final;
    ...
    { 
        strcpy(error_buffer," Your code for invalid address error");
        goto final;
    ...
    { 
         strcpy(error_buffer,"Your code for connection fail");
        goto final;
